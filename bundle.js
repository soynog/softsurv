...
/***/ function(module, exports, __webpack_require__) {
	...
	var surveyEvents = __webpack_require__(34);
	var urlParams = __webpack_require__(37);
	var surveyApi = __webpack_require__(35);
	var surveyUi = __webpack_require__(36);
	...
	var surveyResponsePage = function surveyResponsePage(surveyId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Signs in User
	var signInUser = function signInUser(data, signInCallback) {
	  return function () {
	...
	var addHandlers = function addHandlers(signInCallback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// Helper Functions for Displaying Elements on the Page
	...
	var renderNewSurveyForm = function renderNewSurveyForm() {
	  console.log('render new survey form');
	  var newSurveyForm = __webpack_require__(9);
	  $('.survey-form-holder').append(newSurveyForm);
	};

	// Renders All User's Surveys
	var showAllUserSurveys = function showAllUserSurveys(surveys) {
	  console.log('Showing All User Surveys');
	  var showUserSurveys = __webpack_require__(30);
	  $('.show-all-user-surveys').append(showUserSurveys({
	    surveys: surveys
	  }));
	};

	var clearSplash = function clearSplash() {};
	// Clears the surveys from the page
	var clearSurveys = function clearSurveys() {
	  console.log("Clearing Survey List");
	  $('.show-all-user-surveys').html('');
	};

	// Clear Survey Response form
	var clearResponseForm = function clearResponseForm() {
	...
	var showSurveyPage = function showSurveyPage() {
	...
	var onSurveyResponse = function onSurveyResponse() {
	  clearResponseForm();
	...
	module.exports = {
	  renderNewSurveyForm: renderNewSurveyForm,
	  showAllUserSurveys: showAllUserSurveys,
	  renderSurveyResponseForm: renderSurveyResponseForm,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"modal fade new-survey-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"new-survey\">\n  <div class=\"modal-dialog modal-md\">\n    <div class=\"modal-content\">\n\n      <h4 class=\"modal-title\">Create a new Survey</h4>\n\n      <form id=\"new-survey-form\" class=\"modal-form modal-new-survey-section text\" action=\"index.html\" method=\"post\">\n        <div>\n          <input class=\"survey-question input-fields\" type=\"text\" name=\"survey[question]\" value=\"\" placeholder=\"Survey Question\">\n        </div>\n        <div class=\"survey-options-container center-block\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"survey-option-field","data":data,"indent":"          ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "        </div>\n        <div>\n          <button class=\"btn add-option-button\"><span class=\"glyphicon glyphicon-th-list\"></span></button>\n        </div>\n        <div>\n          <input id=\"create-survey-button\" type=\"submit\" name=\"submit\" class=\"btn add-mint-to-button input-fields\" value=\"Create Survey\">\n        </div>\n      </form>\n\n    </div>\n  </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"option-group input-append\">\n  <input class=\"input-fields option-input\" type=\"text\" name=\"survey[options][]\" value=\"\" placeholder=\"Enter Answer\">\n  <button type=\"button\" class=\"delete-option-button btn-link\" onclick=\"$(this).parent().remove()\">\n    <span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span>\n  </button>\n  <!-- Delete Button onclick removes parent div-->\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"survey-panel panel\">\n      <div class=\"panel-heading\" role=\"tab\" id=\"heading"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n        <h2 class=\"panel-title\">\n          <p class=\"single-survey-url\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    ...
	    + "\" target=\"_blank\">"
	    + alias2(alias1((depth0 != null ? depth0.url : depth0), depth0))
	    + "</a></p>\n        </div>\n        <button id=\"delete-survey\" class=\"btn btn-danger delete-survey\" data-target=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	  ...
	  return "              <tr>\n                <td class='left-col'>"
	    ...
	    + "</td>\n                <td>"
	    + alias2(alias1((depth0 != null ? depth0.percent : depth0), depth0))
	    + "</td>\n              </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n\n<div class=\"clickable-pills panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"panel response-pills\">\n      <div class=\"panel-heading response-pill-heading\">\n        <h2 class=\"panel-title\">"
	    + alias2(alias1((depth0 != null ? depth0.question : depth0), depth0))
	    + "</h3>\n      </div>\n      <div class=\"panel-body response-pill-body\">\n        <form class=\"survey-response-form\" data-target=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.options : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "          <input type=\"submit\" name=\"submit\" class=\"btn add-whipped-cream-to-button input-fields survey-form-submit-button\" value=\"Submit Survey\">\n        </form>\n      </div>\n    </div>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "          <div class=\"radio\">\n            <label>\n              <input type=\"radio\" name=\"surveyOptions\" id=\"surveyOptions-"
	    + alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\" value=\""
	    + alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\">\n              "
	    + alias4(container.lambda((depth0 != null ? depth0.text : depth0), depth0))
	    + "\n            </label>\n          </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!--MODAL SIGN-UP-->\n  <div class=\"container modal fade sign-up-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"sign-up\">\n    <div class=\"modal-dialog modal-sm\">\n      <div class=\"modal-content\">\n        <h1 class=\"modal-logo\">SoftSurv</h1>\n        <h4 class=\"modal-title\">Sign up, it won't take long</h4>\n        <p class=\"sign-up-error hidden\">Oops, something went wrong</p>\n        <form id=\"sign-up-form\" class=\"modal-form modal-sign-up-section text\" action=\"index.html\" method=\"post\">\n          <input class=\"input-fields\" type=\"text\" name=\"credentials[email]\" value=\"\" placeholder=\"Email\">\n          <br>\n          <input class=\"input-fields\" type=\"password\" name=\"credentials[password]\" value=\"\" placeholder=\"Password\">\n          <br>\n          <input class=\"input-fields\" type=\"password\" name=\"credentials[password_confirmation]\" value=\"\" placeholder=\"Password Confirmation\">\n          <br>\n          <br>\n          <input id=\"login-button\" type=\"submit\" name=\"submit\" class=\"btn add-mint-to-button input-fields\" value=\"Signup\">\n        </form>\n\n      </div>\n    </div>\n  </div>\n\n<!--MODAL SIGN-IN-->\n  <div class=\"modal fade sign-in-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"sign-in\">\n    <div class=\"modal-dialog modal-sm\">\n      <div class=\"modal-content\">\n        <h1 class=\"modal-logo\">SoftSurv</h1>\n        <h4 class=\"modal-title\">Log into your account</h4>\n        <p class=\"sign-in-error hidden\">Whoops, couldn't sign in</p>\n        <form id=\"sign-in-form\" class=\"modal-form modal-sign-in-section text\" action=\"index.html\" method=\"post\">\n          <input class=\"input-fields\" type=\"text\" name=\"credentials[email]\" value=\"\" placeholder=\"Email\">\n          <br>\n          <input class=\"input-fields\" type=\"password\" name=\"credentials[password]\" value=\"\" placeholder=\"Password\">\n          <br>\n          <br>\n          <input id=\"login-button\" type=\"submit\" name=\"submit\" class=\"btn add-mint-to-button input-fields\" value=\"Login\" data-toggle=\"modal\">\n        </form>\n\n      </div>\n    </div>\n  </div>\n\n\n<!--MODAL CHANGE PW-->\n  <div class=\"modal fade change-pw-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"sign-up\">\n    <div class=\"modal-dialog modal-sm\">\n      <div class=\"modal-content\">\n        <h1 class=\"modal-logo\">SoftSurv</h1>\n        <h4 class=\"modal-title\">Change your password</h4>\n        <p class=\"change-pw-error hidden\">Oops, couldn't change your password</p>\n        <form id=\"change-pw-form\" class=\"modal-form modal-change-pw-section text\" action=\"index.html\" method=\"patch\">\n          <input class=\"input-fields\" type=\"password\" name=\"passwords[old]\" value=\"\" placeholder=\"Old Password\">\n          <br>\n          <input class=\"input-fields\" type=\"password\" name=\"passwords[new]\" value=\"\" placeholder=\"New Password\">\n          <br>\n          <br>\n          <input id=\"change-pw\" type=\"submit\" name=\"submit\" class=\"btn add-mint-to-button input-fields\" value=\"Change Password\">\n        </form>\n\n      </div>\n    </div>\n  </div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addDeleteHandlers = function addDeleteHandlers() {
	...
	var refreshSurveys = function refreshSurveys() {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#new-survey-form').on('submit', function (event) {
	    ...
	    var options = data.survey.options;
	    console.log(options);
	...
	var addResponseHandlers = function addResponseHandlers() {
	...
	module.exports = {
	  ...
	  addDeleteHandlers: addDeleteHandlers,
	  addResponseHandlers: addResponseHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getSurveys = function getSurveys(success, failure) {
	  console.log("Getting User Surveys");
	  var url = app.api + '/surveys';
	  $.ajax({
	    method: 'GET',
	    url: url,
	    headers: {
	...
	var showSurvey = function showSurvey(success, failure, id) {
	  var url = app.api + '/surveys/' + id;
	  $.ajax({
	    method: 'GET',
	    url: url
	  }).done(success).fail(failure);
	...
	var createSurvey = function createSurvey(success, failure, question, options) {
	...
	var respondSurvey = function respondSurvey(success, failure, id, data) {
	  console.log("patch survey");
	  var url = app.api + '/respond/' + id;
	  var patchData = { index: data.surveyOptions };
	  console.log(id);
	...
	var deleteSurvey = function deleteSurvey(success, failure, id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var respondSurveySuccess = function respondSurveySuccess() {
	  console.log('response success');
	  display.onSurveyResponse();
	};

	// showSurvey success function
	var showSurveySuccess = function showSurveySuccess(data) {
	...
	var createSurveySuccess = function createSurveySuccess(data) {
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  createSurveySuccess: createSurveySuccess,
	  getSurveysSuccess: getSurveysSuccess,
	  showSurveySuccess: showSurveySuccess,
	  respondSurveySuccess: respondSurveySuccess,
...
/***/ function(module, exports) {
	...
	var getUrlParams = function getUrlParams() {
	  ...
	  if (splitUrl.length > 1) {
	    var _ret = function () {
	      var paramStrings = splitUrl[1].split('&').map(function (el) {
	        return el.split('=');
	      });
	      var params = {};
